## vrpn_mocap (kilted) - 1.2.0-1

The packages in the `vrpn_mocap` repository were released into the `kilted` distro by running `/home/alvinsun/micromamba/envs/lyrical/bin/bloom-release --rosdistro kilted --track kilted vrpn_mocap --non-interactive --no-web --override-release-repository-push-url git@github.com:ros2-gbp/vrpn_mocap-release.git` on `Thu, 24 Sep 2026 23:01:24 -0000`
...
## vrpn_mocap (jazzy) - 1.2.0-1

The packages in the `vrpn_mocap` repository were released into the `jazzy` distro by running `/home/alvinsun/micromamba/envs/lyrical/bin/bloom-release --rosdistro jazzy --track jazzy vrpn_mocap --non-interactive --no-web --override-release-repository-push-url git@github.com:ros2-gbp/vrpn_mocap-release.git` on `Thu, 24 Sep 2026 23:00:43 -0000`
...
## vrpn_mocap (humble) - 1.2.0-1

The packages in the `vrpn_mocap` repository were released into the `humble` distro by running `/home/alvinsun/micromamba/envs/lyrical/bin/bloom-release --rosdistro humble --track humble vrpn_mocap --non-interactive --no-web --override-release-repository-push-url git@github.com:ros2-gbp/vrpn_mocap-release.git` on `Thu, 24 Sep 2026 22:59:36 -0000`
